...
export class SubnetMask extends DotDecimal {
   ...
   */
  public static readonly MAX_PREFIX_LENGTH: number = 32;

  /**
   * The numerical values of all valid subnet masks.
   */
  public static readonly ALL_VALID_VALUES: readonly number[] = [
    0xffffffff,
    0xfffffffe,
    0xfffffffc,
    0xfffffff8,
   ...
   */
  public static readonly ALL_VALID: readonly SubnetMask[] = [
  ...
  public constructor(value: number) {
    ...
    this.hostBitCount = SubnetMask.MAX_PREFIX_LENGTH - this.prefixLength;
  ...
  public static validate(value: number, shouldThrow: boolean = true): boolean {
    if (SubnetMask.ALL_VALID_VALUES.includes(value)) {
      return true;
    }
    if (shouldThrow) {
